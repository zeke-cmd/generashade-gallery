  ...
  return (
    <section ref={sectionRef} id="about-contact" className="min-h-screen p-8">
      ...
      <motion.div className="max-w-2xl mb-20 bg-white dark:bg-gray-900 border-2 border-black dark:border-white p-6 md:p-12 relative mx-4 md:mx-auto">
        ...
        <h2 className="text-[4vw] font-bold tracking-tighter mb-6 text-black dark:text-white">About</h2>
        <p className="font-sans text-base md:text-lg leading-relaxed text-black dark:text-white">
      ...
      <motion.div className="max-w-2xl mb-20 mx-4 md:mx-auto">
        <h2 className="text-[4vw] font-bold tracking-tighter mb-6 text-black dark:text-white">Contact</h2>
        <p className="font-sans text-base md:text-lg mb-4 text-black dark:text-white">
          Interested in collaborating or purchasing a piece? Get in touch:
        </p>
        <motion.a 
          href="mailto:zeke@example.com" 
          className="inline-block font-sans border-b-2 border-black dark:border-white hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors text-black dark:text-white"
